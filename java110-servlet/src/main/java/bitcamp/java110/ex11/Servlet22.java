...
public class Servlet22 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 세션 얻기
        // => /ex11/servlet21을 먼저 실행한 후 이 서블릿을 실행하면 웹브라우저가 서버에 요청할 때
        //    이전 서블릿에서 받은 세션 아이디를 요청 프로토콜의 쿠키에 담아서 제출할 것이다.
        // 요청 프로토콜의 세션 아이디 쿠키 정보
        /*
           GET /ex11/servlet22 HTTP/1.1
           ...
           Cookie: age=12; name=hongkildong; JSESSIONID=102DCB88CA956A9D1FCD99BF874679D0 <=== 세션아이디 제출
        */
        //
        // 응답 프로토콜의 예)
