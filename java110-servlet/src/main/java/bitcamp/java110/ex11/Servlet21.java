...
public class Servlet21 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //    => 있다면, 그러나 timeout되어 무효하다면,
        //       없을 때와 똑같이 처리한다.
        // => 없다면,
        //    => 새로 HttpSession 객체를 생성한다.
        //    => 응답할 때 응답 프로토콜의 쿠키 정보로 새로 생성한 세션객체의 세션아이디를 보낸다.
        //    => 웹브라우저는 서버로부터 받은 쿠키 데이터인 세션ID를 서버에 요청할 때 마다 보낼 것이다.
        // 세션 ID를 응답 프로토콜로 보내는 예)
        // => 톰캣 서버에서는 JSSEIONID라는 쿠키 이름으로 세션 아이디를 보낸다.
        // => WAS마다 세션 ID의 쿠키이름이 다를 수 있다.
        /*
         * Set-Cookie: JSESSIONID=102DCB88CA956A9D1FCD99BF874679D0; Path=/; HttpOnly
         */
